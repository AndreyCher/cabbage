...
Only `healthy` proxies are eligible for Identity country pools. Results become unavailable when stale; repeated failures transition endpoints to `unhealthy`.
