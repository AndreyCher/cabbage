...
export function WorkersPage() {
  ...
  return <>
    ...
    <Dialog open={open} onClose={() => setOpen(false)} fullWidth maxWidth="md"><DialogTitle>Create run</DialogTitle><DialogContent><Stack gap={2} mt={1}>
      ...
      <FormControl><InputLabel>Proxy</InputLabel><Select label="Proxy" value={form.proxy_mode} onChange={(e) => setForm({ ...form, proxy_mode: e.target.value })}><MenuItem value="default">Scenario → Identity default</MenuItem><MenuItem value="disabled">Disabled</MenuItem><MenuItem value="selected">Select configuration</MenuItem></Select></FormControl>
